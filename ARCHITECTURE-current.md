...
| [`gb10-memory-budget-and-macbook-offload.md`](https://github.com/guardkit/youtube-channel/blob/main/archive/dgx-spark-estate/gb10-memory-budget-and-macbook-offload.md) (archived) | **Superseded (2026-05 snapshot).** Memory-budget analysis of an earlier lineup; the live lineup above is current. |
...
| [`gb10-model-requirements-matrix.md`](https://github.com/guardkit/youtube-channel/blob/main/archive/dgx-spark-estate/gb10-model-requirements-matrix.md) (archived) | **Superseded (2026-04 analysis).** The original 16-roles→4-models consolidation plan that led to this estate. |
...
| [`llama-swap-config.example.yaml`](https://github.com/guardkit/youtube-channel/blob/main/archive/dgx-spark-estate/examples/llama-swap-config.example.yaml) (archived) | **Superseded.** Old config with vLLM proxy entries. Live config is at `/opt/llama-swap/config/config.yaml`. |
