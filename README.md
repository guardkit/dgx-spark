...
The [Qwen3.8-Flash-Next AutoRound runbook](./RUNBOOK-qwen38-flash-next-autoround-seat.md) now retains **19 GB KV** on `spark-fcf6`, under a **120 decimal GB total-RAM guard**: MTP3, exact top-k, prefix caching and native 262144 context. The [allocation trial](./RESULTS-qwen38-flash-next-kv-ceiling-20260910T181629Z.md) measured **58.79 tok/s** over 139.58 seconds, correct single-conversation cache/tool-history smokes through 250K and **118.534 GB peak effective RAM used**. The 20 GB trial crossed the ceiling; fast retention of two independent full 250K contexts was not demonstrated. The endpoint remains `http://spark-fcf6.local:8888/v1`, model `qwen3.8-flash-next-autoround`. The Spark's original fleet is displaced, swap inactive, the guard active and development APIs disabled. The [prior 12 GB results](./RESULTS-qwen38-flash-next-autoround-seat-20260910T165917Z.md) remain available. The [Lance Hybrid Sharp runbook](./RUNBOOK-qwen38-flash-next-seat.md) is the unexecuted reference. The [reassessment](./qwen38-flash-next-reassessment-2026-09-10.md) explains the selection; the [Factory evaluation](./QWEN38-software-factory-evaluation.md) has not run, so task-quality and completion-time comparisons remain open.
