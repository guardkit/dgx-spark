...
| **M6 Segment close** | Both endpoints answering | "The file that built this box just updated it, declined to churn what didn't need it, and added the front door — same method, same gates, months apart." | Box ends fleet-green with the front door live |
